		...
		steps: [
			...
			},
			{
				...
				items: [
					...
					{
						type: "TextBlock",
						content: "Make sure the key pair format is '.ppk'",
					},
					{
						type: "Image",
				...
				items: [
					{
						type: "Text",
						content:
							"The final step is to configure the storage for your server. If you have 4 cores use 160 GB but if you have 8 cores use 240 GB. Scroll down a bit further to change the configuration shown below.",
					},
					{
						type: "Text",
						content: "These specifications are examples and are yet to be confirmed.",
					},
					{
						type: "TextBlock",
						content: "Change the GiB to 160 for 4 cores but 240 for 8 cores.",
					},
					{
						type: "TextBlock",
			...
			},
			{
				...
				items: [
					{
						type: "Text",
						content: "PuTTY is a tool used to connect to servers like the one we created. To install it head to the Microsoft Store and type...",
					},
					{
						type: "TextBlock",
						content: "Putty",
					...
					{
						type: "Text",
						content: "When you install the program, follow any steps given and accept any prompts. Once this is done, we can move onto connecting to our server.",
					},
					{
						type: "Image",
						src: require("./images/image9.1.png"),
					},
				],
			},
			{
				title: "Configuring PuTTY",
				items: [
					{
						type: "Text",
						content: "You can connect to your server using PuTTY by following the instructions shown below...",
					},
					{
						type: "Text",
						content: "Open PuTTY by using the Windows Start Menu and typing 'Putty'. Open the Program.",
					},
					{
						type: "Image",
						src: require("./images/image9.2.png"),
					},
					{
						type: "Text",
						content:
							"We now need to set the authentication method of PuTTY to allow us to access the server. To do this, press the following buttons which are shown in the screenshot below to get to the correct section.",
					},
					{
						type: "TextBlock",
						content: "SSH",
					...
					{
						type: "Text",
						content: "Press the Browse button then select the ppk file in your Downloads.",
					},
					{
						type: "Image",
						src: require("./images/image9.3.png"),
					},
					{
						type: "Image",
						src: require("./images/image9.4.png"),
					},
					{
						type: "Text",
						content: "Now you have loaded your ppk file, we can now move onto connecting to your server.",
					},
				],
			},
			{
				...
				items: [
					{
						type: "Text",
						content:
							"We need our server IP Address to navigate to the correct server. We can get this from the running instances page which you should be on after launching the instance.",
					},
					{
						type: "Text",
						content: "Click on the checkmark next to your running instance to show the server details.",
					},
					{
						type: "Text",
			...
			},
			{
				...
				items: [
					{
						type: "Text",
						content: "Now we have our Ip Address, we can navigate back to PuTTY and input these details",
					},
					{
						type: "Text",
						content: "On the left sidebar in the PuTTY app, scroll to the top and click...",
					},
					{
						type: "TextBlock",
						content: "Session",
			...
			},
			{
				...
				items: [
					...
					{
						type: "Image",
						src: require("./images/image21.png"),
					},
					{
						type: "Command",
